    ...
    <div className='bg-white'>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-col">
          <div className="lg:w-4/6 mx-auto">
            {/* <div className="w-[100%] m-auto">
              <img alt="content" className="m-auto" src={Logo} />
            </div> */}
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-0 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Web Shop online do'konidan narsa sotib olganlar !</h1>
              ...
              <div className="h-[500px] m-auto mb-[-100px]" key={data.id}>
                <div className="flex flex-wrap">
                  <div className="lg:w-1/4 md:w-1/2 p-4">
                    <div className="block relative h-[350px] w-[350px] rounded overflow-hidden">
        ...
        <div className=" py-8 px-4 mx-auto max-w-[88%] text-center lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={SH} alt="Joseph Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">ShahriyorDev</a>
              </h3>
              <p>Full-stack - Middle & Teacher</p>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={DEV} alt="Helene Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Muhammad</a>
              </h3>
